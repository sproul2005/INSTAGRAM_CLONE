...
const ChatPage = () => {
    ...
    const sendMessageHandler=async (receiverId)=>{
        try{
              const res=await axios.post(`https://instagram-clone-qobx.onrender.com/api/v1/message/send/${receiverId}`,
                {textMessage},{
                  headers:{
        ...
        selectedUser ? (
           <section className='flex-1 border-l border-l-gray-300 flex flex-col h-full'>
            ...
            <div className='flex flex-col items-center justify-center mx-auto'>
                ...
                <span className='p-1'>Send a message to start a chat.</span>
                <Button className='w-fit mx-auto bg-[#0095F6] hover:bg-[#258bcf]'>Send Message</Button>
            </div>
        )
      }
    </div>
