        ...
        <div className='flex max-w-2xl mx-auto pl-10'>
            <section className='flex flex-col gap-6 w-full'>
                ...
                <div>
                    ...
                    <Textarea value={input.bio} onChange={(e) => setInput({ ...input, bio: e.target.value })} name='bio' className="border border-gray-300 focus:border-gray-600 focus:ring-0 focus-visible:ring-0" />
                </div>
                <div>
